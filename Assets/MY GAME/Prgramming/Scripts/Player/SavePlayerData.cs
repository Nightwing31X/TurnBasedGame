...
//        public PlayerData playerDataSave;
...
//        public void Load()
//        {
//            if (!File.Exists($"{Application.persistentDataPath}/PlayerDataSaved.txt")) { return; }
//            Debug.Log("YES");

//            string json = File.ReadAllText($"{Application.persistentDataPath}/PlayerDataSaved.txt");
...
//        {
//            Load();
//            Debug.Log("SavedPlayerData script has ran...");
//        }

//        public void RefValues()
//        {
//            //playerDataSave.fullscreen = refFullscreen;
...
//            Debug.Log("SavedValues has ran...");
//            //refFullscreen = playerDataSave.fullscreen;
...
//        [SerializeField] public string playerName = "Bob";
